  ...
  return (
    <div className='flex flex-col items-center justify-center w-6/12 mx-auto min-w-100'>
      <div className='w-full p-8 bg-white-500 bg-opacity-70 rounded-lg shadow-md bg-clip-padding backdrop-filter backdrop-blur-lg'>
        ...
        <h1 className='text-green-500 font-bold text-center'>Sign Up <span className='text-blue-500'>ChatApp</span></h1>
        <div className="text-blue-500 py-5 text-xl">{email}</div>
        <form onSubmit={handleSubmit}>
          <div>
            <label className='p-2 label'><span className='text-yellow-500 font-bold text-center'>Full Name</span></label>
          ...
          <div>
            <label className='p-2 label'><span className='text-yellow-500 font-bold text-center'>Username</span></label>
          ...
          <div>
            <label className='p-2 label'><span className='text-yellow-500 font-bold text-center'>Password</span></label>
          ...
          <div>
            <label className='p-2 label'><span className='text-yellow-500 font-bold text-center'>Confirm Password</span></label>
          ...
          <div className='flex'>
            <div className='form-control'>
              <label className={`label gap-2 cursor-pointer ${inputs.gender === "male" ? "selected" : ""}`}><span className='text-yellow-500 font-bold text-center'>Male</span></label>
              <input type='checkbox' className='checkbox border-slate-900' checked={inputs.gender === "male"} onChange={() => handleCheckboxChange("male")} />
            </div>
            <div className='form-control'>
              <label className={`label gap-2 cursor-pointer ${inputs.gender === "female" ? "selected" : ""}`}><span className='text-yellow-500 font-bold text-center'>Female</span></label>
          ...
          <Link className='text-yellow-500 font-bold text-center inline-block mt-4 text-sm hover:underline hover:text-blue-600' to="/login">Already have an account?</Link>
          <div>
